(function() {
    ...
    function handleText(textNode)
    {
        ...
        v = v.replace(/\bClouds\b/g, "Butts");
        v = v.replace(/\bcongress\b/g, "Edward Norton");
        v = v.replace(/\bCongress\b/g, "Edward Norton");
        v = v.replace(/\bIn my opinion\b/g, "By the will of Odin");
        v = v.replace(/\bin my opinion\b/g, "by the will of Odin");
        v = v.replace(/\bshitlord\b/g, "kind and intelligent human being");
        v = v.replace(/\bShitlord\b/g, "kind and intelligent human being");
        v = v.replace(/\bmanagement\b/g, "the high council of the Time Lords");
        v = v.replace(/\bManagement\b/g, "The high council of the Time Lords");
        v = v.replace(/\bGoogle\b/g, "1994's Yahoo");
